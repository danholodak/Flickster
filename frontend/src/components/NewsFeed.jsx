        ...
        <section className="content news-feed">
            ...
            <section className="photo-column news-feed">
                        ...
                        <div key={i} className="news-feed-box">
                            ...
                            <img className="prof-pic-small"  src={users[photo.userId]?.profilePicUrl ? users[photo.userId].profilePicUrl : "https://flickster-default-pics.s3.us-east-2.amazonaws.com/cow.jpg"} alt="Profile pic" onClick={()=>history.push(`/photos/${photo.userId}`)}/>
