...
export default function SubHeader({selection}){
    ...
    if (user){
        return (
            ...
            <div className="banner-pic" style={{backgroundImage: `url(${user.headerPhotoUrl})`, backgroundPosition: 'center center'}}>
                <section className="left-subheader">
                    <div className="prof-pic-holder" onClick={profilePicClick}>
                        ...
                        <img className="prof-pic" src={user.profilePicUrl} alt="Profile pic" />
                    </div>
